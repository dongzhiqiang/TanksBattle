 ...
 * @returns {PetTalentLvConfig}
 */
function getPetTalentLvConfig(key)
{
    return gameConfig.getCsvConfig("petTalentLv", key);
}

exports.PetTalentLvConfig = PetTalentLvConfig;
exports.getPetTalentLvConfig = getPetTalentLvConfig;