...
////////////我的逻辑模块////////////
var defaultLogic    = require("../logic/default");
var staticFile      = require("../logic/staticFile");
var adminHandler    = require("../logic/admin");
var getServers      = require("../logic/getServers");
var loginHandler    = require("../logic/login");
var logoutHandler   = require("../logic/logout");
var modifyPassword  = require("../logic/modifyPassword");
var registerHandler = require("../logic/register");
var checkLogin      = require("../logic/checkLogin");
var notifySvrAlive  = require("../logic/notifySvrAlive");
var notifySvrDown   = require("../logic/notifySvrDown");
var updateRole      = require("../logic/updateRole");
var requestNewRole  = require("../logic/requestNewRole");
var requestDelRole  = require("../logic/requestDelRole");
var requestNewCorps= require("../logic/requestNewCorps");
var requestDelCorps = require("../logic/requestDelCorps");
...
var routerNormalCfg    =
{
    ...
    "/notifySvrAlive"   : notifySvrAlive,
    "/notifySvrDown"    : notifySvrDown,
    "/updateRole"       : updateRole,
    "/requestNewRole"   : requestNewRole,
    "/requestDelRole"   : requestDelRole,
    "/requestNewCorps"   : requestNewCorps,
    "/requestDelCorps"   : requestDelCorps,
};
...
[
    {
        reg  : new RegExp("\/" + appCfg.resDirName + "\/.*"),
        proc : staticFile
    }
];
