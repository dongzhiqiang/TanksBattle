 ...
 * @returns {PropDistributeConfig}
 */
function getPropDistributeConfig(key)
{
    return gameConfig.getCsvConfig("propDistribute", key);
}

exports.PropDistributeConfig = PropDistributeConfig;
exports.getPropDistributeConfig = getPropDistributeConfig;