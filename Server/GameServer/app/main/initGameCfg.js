...
var TreasureRobBasicCfg = require("../logic/gameConfig/treasureRobConfig").TreasureRobBasicCfg;
var TreasureRobPieceCfg = require("../logic/gameConfig/treasureRobConfig").TreasureRobPieceCfg;
var EliteLevelBasicCfg = require("../logic/gameConfig/eliteLevelConfig").EliteLevelBasicCfg;
var EliteLevelCfg = require("../logic/gameConfig/eliteLevelConfig").EliteLevelCfg;
var EliteLevelResetCfg = require("../logic/gameConfig/eliteLevelConfig").EliteLevelResetCfg;
...
var ArenaRankCfg = require("../logic/gameConfig/arenaConfig").ArenaRankCfg;
...
var TreasureConfig=require("../logic/gameConfig/treasureConfig").TreasureConfig;
var TreasureLevelConfig=require("../logic/gameConfig/treasureConfig").TreasureLevelConfig;
...
var StarRewardConfig = require("../logic/gameConfig/starRewardConfig").StarRewardConfig;
var WarTriedBaseConfig = require("../logic/gameConfig/warriorTriedConfig").WarTriedBaseConfig;
var TriedRefreshCostConfig = require("../logic/gameConfig/warriorTriedConfig").TriedRefreshCostConfig;
var TriedStarConfig = require("../logic/gameConfig/warriorTriedConfig").TriedStarConfig;
var TriedLevelConfig = require("../logic/gameConfig/warriorTriedConfig").TriedLevelConfig;
var TriedLevelRoomConfig = require("../logic/gameConfig/warriorTriedConfig").TriedLevelRoomConfig;
var ProphetTowerConfig = require("../logic/gameConfig/prophetTowerConfig").ProphetTowerConfig;
var ProphetTowerRewardConfig = require("../logic/gameConfig/ProphetTowerRewardConfig").ProphetTowerRewardConfig;
var rankBasicConfig = require("../logic/gameConfig/rankConfig").RankBasicConfig;
var rankLikeRewardCfg = require("../logic/gameConfig/rankConfig").RankLikeReward;
var ItemInitListConfig = require("../logic/gameConfig/itemConfig").ItemInitListConfig;
var TreasureRobotConfig = require("../logic/gameConfig/treasureRobotConfig").TreasureRobotConfig;
...
var cfgObjs1 = {
    ...
    "starReward" : {file:"room/starReward.csv", rowType:StarRewardConfig, rowKey:"id"},
    ...
    "treasureRobBasic" : {file:"activity/treasureRobBasic.csv", rowType:TreasureRobBasicCfg},
    "treasureRobPiece" : {file:"activity/treasureRobPiece.csv", rowType:TreasureRobPieceCfg},
    "eliteLevelBasic" : {file:"activity/eliteLevelBasic.csv", rowType:EliteLevelBasicCfg},
    "eliteLevel" : {file:"activity/eliteLevel.csv", rowType:EliteLevelCfg, rowKey:"id"},
    "eliteLevelReset" : {file:"activity/eliteLevelReset.csv", rowType:EliteLevelResetCfg, rowKey:"count"},
    ...
    "arenaRank" : {file:"activity/arenaRankCfg.csv", rowType:ArenaRankCfg, rowKey:"rank"},
    ...
    "treasure"  : {file:"treasure/treasure.csv", rowType:TreasureConfig, rowKey:"id"},
    "treasureLevel"  : {file:"treasure/treasureLevel.csv", rowType:TreasureLevelConfig},
    ...
    "base" : {file:"warriorsTried/base.csv", rowType:WarTriedBaseConfig},
    "refreshCost" : {file:"warriorsTried/refreshCost.csv", rowType:TriedRefreshCostConfig, rowKey:"num"},
    "starTried" : {file:"warriorsTried/starTried.csv", rowType:TriedStarConfig, rowKey:"key"},
    "triedLevel" : {file:"warriorsTried/triedLevel.csv", rowType:TriedLevelConfig, rowKey:"roomId"},
    "levelRoom" : {file:"warriorsTried/levelRoom.csv", rowType:TriedLevelRoomConfig},
    "prophetTower" : {file:"activity/prophetTower.csv", rowType:ProphetTowerConfig},
    "prophetReward" : {file:"activity/prophetTowerStageReward.csv", rowType:ProphetTowerRewardConfig,rowKey:"id"},
    "rankBasic" : {file:"rank/rankBasicConfig.csv", rowType:rankBasicConfig},
    "rankLikeReward" : {file:"rank/rankLikeReward.csv", rowType:rankLikeRewardCfg},
    "itemInitList" : {file:"item/itemInitList.csv", rowType:ItemInitListConfig, rowKey:"roleId"},
    "treasureRobot" : {file:"activity/treasureRobot.csv", rowType:TreasureRobotConfig},
};
