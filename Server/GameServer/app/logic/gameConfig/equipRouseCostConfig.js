 ...
 * @returns {EquipRouseCostConfig}
 */
function getEquipRouseCostConfig(key)
{
    return gameConfig.getCsvConfig("equipRouseCost", key);
}

exports.EquipRouseCostConfig = EquipRouseCostConfig;
exports.getEquipRouseCostConfig = getEquipRouseCostConfig;