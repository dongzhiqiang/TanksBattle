 ...
 * @returns {PropValueConfig}
 */
function getPropValueConfig(key)
{
    return gameConfig.getCsvConfig("propValue", key);
}

exports.PropValueConfig = PropValueConfig;
exports.getPropValueConfig = getPropValueConfig;