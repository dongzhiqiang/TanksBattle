 ...
 * @returns {PetUpstarCostConfig}
 */
function getPetUpstarCostConfig(key)
{
    return gameConfig.getCsvConfig("petUpstarCost", key);
}

exports.PetUpstarCostConfig = PetUpstarCostConfig;
exports.getPetUpstarCostConfig = getPetUpstarCostConfig;