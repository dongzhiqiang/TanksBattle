...
public class UIEquipPageRouse : MonoBehaviour
{
    ...
    void OnRouse()
    {
        ...
        NetMgr.instance.EquipHandler.SendRouse(RoleMgr.instance.Hero.GetString(enProp.guid), equipCfg.posIndex);
    ...
    void Awake()
    {
        ...
        rouseActList2.Add(new GrowActFxPlay(GetComponentInParent<UIEquip>().m_equipFx));

        List<GrowAct> rouseActList3 = new List<GrowAct>();
        rouseActList3.Add(new GrowActFunc(() => UIMgr.instance.Get<UIEquip>().Refresh()));
        ...
        m_rouseFxMgr.m_flyIconFx = GetComponentInParent<UIEquip>().m_flyIconFx;
        //m_rouseFxMgr.m_callback = () => UIMgr.instance.Get<UIEquip>().Refresh();
    }
