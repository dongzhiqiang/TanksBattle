...
{
    public class AllowBeAttackCfg : ConditionalCfg
    {
    ...
    public class AllowBeAttack : Conditional
    {
        AllowBeAttackCfg CfgEx { get { return (AllowBeAttackCfg)m_cfg; } }
        ...
        protected override enNodeState OnExecute(enExecute executeType) {
            ...
            if (r.RSM.IsAir || r.GetGrabTarget() != null)
                return enNodeState.failure;
