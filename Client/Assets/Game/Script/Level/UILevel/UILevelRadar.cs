...
public class UILevelRadar : MonoBehaviour
{
    public Role m_role;
    public ImageEx arrowImg;
    float m_size = 40.0f;
    ...
    void LateUpdate()
    {
        ...
        if (m_role == null || m_role.State == Role.enState.dead || m_role.transform == null)
        {
        ...
        arrowImg.gameObject.SetActive(isVisible);
        if (!isVisible)
            return;
