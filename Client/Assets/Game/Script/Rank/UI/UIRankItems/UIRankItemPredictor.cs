...
public class UIRankItemPredictor : UIScrollWrapItem
{
    ...
    public TextEx m_maxLayer;
    public TextEx m_passTime;
    ...
    public override void OnInitData(object data)
    {
        ...
        var myRankData = (PredictorRankItem)dataWrapper.data;
        ...
        m_maxLayer.text = myRankData.maxLayer.ToString();
        m_passTime.text = StringUtil.FormatTimeSpan(myRankData.passTime);
