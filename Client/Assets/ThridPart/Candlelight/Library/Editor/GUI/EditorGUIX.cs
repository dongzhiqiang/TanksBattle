...
namespace Candlelight
{
	...
	public static partial class EditorGUIX
	{
		...
		private static readonly List<GUIContent> s_LayerLabels = new List<GUIContent>(32);
		private static readonly List<int> s_LayerValues = new List<int>(32);
		...
		public static int DisplayLayerPopup(Rect position, GUIContent label, int currentValue)
		{
			...
			for (int i = 0; i < s_MaxNumLayers; ++i)
			{
				...
				{
					s_LayerLabels.Add(new GUIContent(layerName));
					s_LayerValues.Add(i);
				}
			}
			return EditorGUI.IntPopup(position, label, currentValue, s_LayerLabels.ToArray(), s_LayerValues.ToArray());
		}
