...
/*	fixed samples[10] = {-0.08,-0.05,-0.03,-0.02,-0.01,0.01,0.02,0.03,0.05,0.08};
	...
	dir *= _SampleDist;
	sum +=	tex2D(_MainTex, texCoord + dir*-0.08) + tex2D(_MainTex, texCoord + dir*0.08) + 
			tex2D(_MainTex, texCoord + dir*-0.05) + tex2D(_MainTex, texCoord + dir*0.05) + 
			tex2D(_MainTex, texCoord + dir*-0.03) + tex2D(_MainTex, texCoord + dir*0.03) + 
			tex2D(_MainTex, texCoord + dir*-0.02) + tex2D(_MainTex, texCoord + dir*0.02) + 
			tex2D(_MainTex, texCoord + dir*-0.01) + tex2D(_MainTex, texCoord + dir*0.01);
