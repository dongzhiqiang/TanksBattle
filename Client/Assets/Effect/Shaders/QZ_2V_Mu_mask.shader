...
////// Emissive:
                ...
                float2 node_2281 = (i.uv0+(_01T*node_6064.g)*float2(0,0.1));
                float4 _01_var = tex2D(_01,TRANSFORM_TEX(node_2281, _01));
                float4 node_9790 = _Time + _TimeEditor;
                float2 node_2567 = (i.uv0+(_02T*node_9790.g)*float2(0,0.1));
