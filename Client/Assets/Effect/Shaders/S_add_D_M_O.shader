    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                clip((((_T1_var.a*_T2_var.a)*(_Mask_var.a*_msk_size))*_D) - 0.5);
////// Lighting:
////// Emissive:
